                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <a href="/dashboard/empresas" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-sm text-white-50"></i> Voltar</a>
                            <h2 class="m-0 font-weight-bold text-primary">Atualizar Dados</h2>
                        ...
                        <div class="col-md-9">
                            @section('script')
                                ...
                                @endsection
                            <h3 class="m-0 font-weight-bold text-primary">Editando:<b> {{ $empresa->nome }}</b></h3>
                            <form action="/dashboard/empresas/update/{{ $empresa->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <br>
                                Nome:
                                ...
                                <br>
                                Celular:
                                <input type="text" class="form-control" id="telefone" name="tel"  value="{{ $empresa->tel }}">
                                <br>
                                Celular:
